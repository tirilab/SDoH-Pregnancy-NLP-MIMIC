...
"""# Randomly selecting 40 notes and 10 notes for manually annotating and ground truth creation
...
"""# 60 manually annotated notes, 50 from MIMIC, and 10 notes generated by GPT."""

mimic_annotations=pd.read_csv('/content/drive/My Drive/Colab Notebooks/nlp project/forannotation_frommimic.csv')
gpt_annotations=pd.read_csv('/content/drive/My Drive/Colab Notebooks/nlp project/Annotation_fromgpt.csv')
...
gpt_annotations.rename(columns={'TEXT': 'TEXT_mimic', 'GPT generated notes': 'TEXT_combined'}, inplace=True)

"""# Below are 60 notes for model development with ground truth, let start by building a rule based model to extract SDOH
...
keyword_dict = {
    "kp_social_support": ["live with someone", "live with family", "live with friends",'lives with husband','lives with', 'supportive','support'],
}
...
classifiers = [
    ...
    DecisionTreeClassifier(criterion='entropy', class_weight='balanced', random_state=421)
]
